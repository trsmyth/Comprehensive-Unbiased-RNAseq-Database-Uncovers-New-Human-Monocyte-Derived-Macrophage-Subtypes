...
importance_value <- importance_value %>% arrange(desc(Importance)) %>% slice(1:10000)
...
save(file = 'Top_10000_Pruned_RF_Model.RData',
...
importance_value <- importance_value %>% arrange(desc(Importance)) %>% slice(1:1000)
