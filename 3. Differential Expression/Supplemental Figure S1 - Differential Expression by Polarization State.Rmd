...
### This file performs differential expression analysis of monocyte-derived macrophage count data by polarization state using limma-voom. Raw count data of gene and sample selected MDM data from 'Gene and Sample Selection' is the input data for this analysis.
...
Pol_DEG_Results <- DEG_Results

save(Pol_DEG_Results,
     file = 'Pol_State_DEG_Results.RData')
```
